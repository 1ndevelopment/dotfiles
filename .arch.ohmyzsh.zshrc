...
alias rfsh='cls && source ~/.zshrc && ll'
alias n='nano'
alias open='firefox'
alias dl='aria2c'

alias pmlstin='pacman -Q'
alias pmlst='pacman -Ss'
alias pmlstupg='pacman -Qu'
alias pmupd='sudo pacman -Sy'
alias pmupg='sudo pacman -Su'
alias pmins='sudo pacman -S '
alias pmuni='sudo pacman -R'
alias pmar='sudo pacman -Rns $(pacman -Qtdq)'
alias pmfix='sudo pacman -Syu --overwrite="*"'
alias pmcln='sudo pacman -Sc'
